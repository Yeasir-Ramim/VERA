"""
Generator for notebooks/VERA_Kaggle_Training.ipynb and notebooks/VERA_Phase2_Colab_Kaggle_Training.ipynb
Universal Kaggle Multi-Dataset Recursive Loader
"""
import json
...
def create_kaggle_notebook():
    ...
    with open(out_dir / "VERA_Kaggle_Training.ipynb", "w", encoding="utf-8") as f:
        json.dump(notebook_dict, f, indent=2)
    print("Created universal multi-dataset Kaggle notebook successfully.")
